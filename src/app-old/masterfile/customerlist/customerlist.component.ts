...
//   {customercode: 'ABC123', customername: 'Sudheer', email: 'sudheer@test.com', addressline: 'Hyderabad', postcode: 600012, state: 'Telangana', status: 'Active'},
//   {customercode: 'ABC123', customername: 'Sudheer', email: 'sudheer@test.com', addressline: 'Hyderabad', postcode: 600012, state: 'Telangana', status: 'Active'},
//   {customercode: 'ABC123', customername: 'Sudheer', email: 'sudheer@test.com', addressline: 'Hyderabad', postcode: 600012, state: 'Telangana', status: 'Active'},
//   {customercode: 'ABC123', customername: 'Sudheer', email: 'sudheer@test.com', addressline: 'Hyderabad', postcode: 600012, state: 'Telangana', status: 'Active'},
//   {customercode: 'ABC123', customername: 'Sudheer', email: 'sudheer@test.com', addressline: 'Hyderabad', postcode: 600012, state: 'Telangana', status: 'Active'},
...
//   displayedColumns: string[] = ['customercode', 'customername', 'email', 'addressline', 'addressline', 'postcode', 'state', 'status'];
...
export class CustomerlistComponent implements OnInit {
  ...
  customer_list(
    ...
    let search = search_column ? search_column : 'email';
    let input_data = {
      columns: [
        {
          data: search,
